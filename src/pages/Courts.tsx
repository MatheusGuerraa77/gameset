...
// Now let's create separate components for the main parts of the page
import AdvancedFilters from '@/components/courts/AdvancedFilters';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Search Header */}
        <CourtsHeader onSearch={handleSearch} />
          ...
          <div className="gameset-container">
            <div className="flex flex-col md:flex-row justify-between mb-6">
              ...
              <div className="mt-4 md:mt-0">
                <AdvancedFilters priceRange={priceRange} setPriceRange={setPriceRange} />
              </div>
            </div>
